...
#[Route('/realisateurs')]
final class RealisateursController extends AbstractController
{
    #[Route(name: 'app_realisateurs_index', methods: ['GET'])]
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_realisateurs_index', [], Response::HTTP_SEE_OTHER);
        }
